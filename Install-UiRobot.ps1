...
function Main {
    ...
    Process {
        ...
        Try {
            ...
            $orchWebResponse = Invoke-RestMethod -Uri $orchUrl_login -Method Post -Body $dataLogin -ContentType "application/json" -UseBasicParsing -Session websession -DisableKeepAlive
        ...
        Try {
            ...
            $botWebResponse = Invoke-RestMethod -Uri $orch_bot -Method Post -Body $dataRobot -ContentType "application/json" -UseBasicParsing -WebSession $websession -DisableKeepAlive
